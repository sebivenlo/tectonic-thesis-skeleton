...
%\addsec{Statement of Authenticity}
...
\IfFileExists{authenticity_signature.png}{%
  ...
  \includegraphics[width=.4\linewidth]{authenticity_signature.png}%
    ...
    \includegraphics[width=.4\linewidth]{authenticity_signature-example.png}%

  \fbox{\begin{minipage}{.6\linewidth}\sloppypar
      If you add a file called \texttt{authenticity\_signature.png} to root
      folder of your build, that will be included as signature here,
      instead of this text block and the fake signature above.
    \end{minipage}
  }}
